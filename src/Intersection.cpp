...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // took FP.6b out of lock as suggested in Review
    lck.unlock();
...
{
    // FP.6a : Done
    // In Intersection.h, add a private member _trafficLight of type TrafficLight. At this position, start the simulation of _trafficLight.
